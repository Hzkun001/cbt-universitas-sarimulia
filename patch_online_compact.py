      ...
      <div className="bg-white dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 rounded-lg shadow-sm overflow-hidden flex flex-col">
        ...
        <div className="divide-y divide-slate-200 dark:divide-zinc-800">
          {sesis.map(({ s, u, ex, dijawab, totalSoal, progress }) => {
            ...
            return (
              <div key={s.id} className="p-4 hover:bg-slate-50 dark:hover:bg-zinc-900/50 transition-colors flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center gap-3 min-w-0 md:w-1/3">
                  <div className="hidden sm:flex h-9 w-9 shrink-0 rounded-md bg-slate-100 dark:bg-zinc-800 items-center justify-center border border-slate-200 dark:border-zinc-700">
                ...
                <div className="flex items-center gap-6 shrink-0 md:w-1/4 justify-between md:justify-end">
                  <div className="text-right">
                    <div className="text-[10px] font-semibold uppercase tracking-wider text-slate-500 mb-1">Sisa Waktu</div>
