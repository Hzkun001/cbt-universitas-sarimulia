...
with open('src/routes/_authenticated/admin.evaluasi.$id.tsx', 'r') as f:
    content = f.read()

replacement = """import { createFileRoute, Link, useParams } from "@tanstack/react-router";
...
with open('src/routes/_authenticated/admin.evaluasi.$id.tsx', 'w') as f:
    f.write(replacement)
