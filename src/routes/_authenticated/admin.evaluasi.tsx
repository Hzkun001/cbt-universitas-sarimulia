...
function EvaluasiList() {
 ...
 params={{ id: ujian.id}}
 className="group flex flex-col md:flex-row md:items-center justify-between p-6 sm:p-8 bg-white/80 dark:bg-zinc-900/60 backdrop-blur-xl rounded-3xl border border-slate-200/80 dark:border-zinc-800/80 shadow-sm hover:shadow-md transition-colors gap-6"
 >
 <div className="flex items-center gap-6 min-w-0">
 <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-100 dark:border-indigo-500/20 transition-transform">
 ...
 <div className="h-10 w-10 rounded-full bg-slate-50 dark:bg-zinc-800 flex items-center justify-center transition-transform group-hover:bg-indigo-100 dark:group-hover:bg-indigo-900/40">
