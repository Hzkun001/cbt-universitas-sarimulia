...
function EvaluasiSesi() {
 ...
 <Link 
 to="/admin/evaluasi"
 className="inline-flex items-center gap-2 text-sm font-bold text-slate-500 hover:text-slate-900 dark:hover:text-zinc-100 transition-colors"
 >
 ...
 <div className={`p-6 md:px-8 border-t transition-colors ${isGraded ? 'border-slate-100 dark:border-zinc-800/80 bg-slate-50/50 dark:bg-zinc-950/30' : 'border-amber-100 dark:border-amber-900/30 bg-amber-50/30 dark:bg-amber-950/10'}`}>
 ...
 placeholder="0"
 className="w-24 h-12 text-center text-xl font-black bg-white dark:bg-zinc-900 border-2 border-slate-200 dark:border-zinc-700 rounded-xl focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 outline-none transition-all hover:border-slate-300"
 />
 </div>
 ...
 className="w-full h-12 px-4 font-medium bg-white dark:bg-zinc-900 border-2 border-slate-200 dark:border-zinc-700 rounded-xl focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 outline-none transition-all hover:border-slate-300"
 />
 </div>
 </div>
 </div>
 ...
 <div className="bg-white/80 dark:bg-zinc-900/60 backdrop-blur-xl rounded-3xl border border-slate-200/80 dark:border-zinc-800/80 shadow-xl shadow-slate-900/5 overflow-hidden flex flex-col">
 ...
 <button 
 onClick={selesaikan}
 className={`w-full h-14 rounded-xl font-black text-sm tracking-wide transition-all shadow-md ${
 totalUngraded > 0 
